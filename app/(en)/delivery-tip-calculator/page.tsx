          ...
          {[
            {
              ...
              a: "DoorDash dashers earn a base pay per delivery plus 100% of your tip. A minimum of $3–$4 for small orders, or 15–20% for larger ones, is considered fair. DoorDash recommends a default of 15%.",
            },
            {
              q: "How much should I tip on Uber Eats?",
              a: "Uber suggests 15–20% as a default. Uber Eats couriers receive 100% of your tip. You can adjust the tip up to 1 hour after delivery.",
            },
            {
              q: "Is it okay not to tip for delivery?",
              a: "Not tipping is your right, but it directly reduces the courier's income. Drivers can see the tip before accepting an order — no tip or low tip may mean longer wait times. For adequate service, a minimum of $3–$4 is considerate.",
            },
            {
              q: "Does the delivery fee go to the driver?",
              a: "No. Delivery fees, service fees, and small order fees go to the platform. Only the tip field goes directly to the driver.",
            },
          ].map(({ q, a }) => (
