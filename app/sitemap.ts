...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/doordash-tip-calculator/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/uber-eats-tip-calculator/`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${BASE}/es/doordash-tip-calculator/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/es/uber-eats-tip-calculator/`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
