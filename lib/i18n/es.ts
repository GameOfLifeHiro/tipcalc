...
const es: Translations = {
  ...
  calc: {
    ...
    taxAmountHint: "De tu recibo — déjalo en blanco para propinar sobre el total",
    advancedToggle: "Avanzado: cargos, cargo de servicio, redondeo",
    feesLabel: "Cargos",
    ...
    tipBaseSuffix: "(subtotal sin impuestos; cargos excluidos)",
