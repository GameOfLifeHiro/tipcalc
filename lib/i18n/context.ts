...
const defaultTranslations: Translations = {
  ...
  calc: {
    ...
    preTaxCheck: "Pre-tax tipping", preTaxDesc: "— exclude sales tax & fees from the tip base",
    salesTaxLabel: "Sales Tax %", feesLabel: "Fees", svcChargeLabel: "Svc Charge",
    ...
    tipBasePrefix: "Tip base:", tipBaseSuffix: "(tax, fees & service charge excluded)",
