...
const en: Translations = {
  ...
  calc: {
    ...
    preTaxCheck: "Pre-tax tipping",
    preTaxDesc: "— exclude sales tax & fees from the tip base (recommended by etiquette sources)",
    ...
    tipBaseSuffix: "(tax, fees & service charge excluded)",
    copyBtn: "Copy Result",
    copyDone: "✓ Copied!",
    shareBtn: "Share Link",
